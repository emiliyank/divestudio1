                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" name="topic" id="topic" required placeholder="{{trans('static.topic')}}*" value="{{$cm_static_page->getTranslation(\Session::get('language'))->topic}}">
                                </div>
                            </div> 
                            ...
                            <div class="form-group">
                                <div class="col-sm-6">
                                    ...
                                    <textarea name="content" id="content" placeholder="{{trans('static.content')}}*" onFocus="focusLink(true)" onBlur="focusLink(false)" required>{{$cm_static_page->getTranslation(\Session::get('language'))->content}}</textarea>
                                </div>
                            </div>
